...
Parser :: Parser(string *tmp, float var)
{
	...
	TryShiftBrackets();
	//
	OutText << "in main Parser:" << endl;
	for (int check = limit.first; check <= limit.second; check++)
		OutText << ParserStr[check];
	OutText << endl;
	//
...
Parser :: Parser(int left, int right)
{
	...
	TryShiftBrackets();
	//
	OutText << "in several Parser:" << endl;
	for (int check = limit.first; check <= limit.second; check++)
		OutText << ParserStr[check];
	OutText << endl;
	//
...
void Parser :: OneOperandOperatorFind()
{
	...
	//
	OutText << "in OneOperandOperatorFind:" << endl;
	OutText << strtmp;
	OutText << endl;
	//
}
...
float Parser :: ConvertToFloat()
{
	TryShiftBrackets();
	//
	OutText << "in ConvertToFloat:" << endl;
	for (int check = limit.first; check <= limit.second; check++)
		OutText << ParserStr[check];
	OutText << endl;
	//
